    ...
    <div class="col-xs-8">
    	<div class="panel panel-primary">
        	<div class="panel-heading">
          		<h3 class="panel-title">Offline Messages</h3>
        	</div>
        <div class="panel-body">
          	<table id="lista_msgoff" class="table table-striped">
				<thead>
	    			<tr>
				        <th>#</th>
				        <th>ID</th>
				...
				<s:iterator value="msgOff">
				<s:set var="idLeilao"> <s:property value="id"/></s:set>
	
				<tr>
				    <td><s:property value="nr"/></td>
