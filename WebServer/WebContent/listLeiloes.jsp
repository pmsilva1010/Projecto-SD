...
<body>
    ...
    <div class="col-xs-6">
    	<div class="panel panel-primary">
        	<div class="panel-heading">
          		<h3 class="panel-title">My Auctions</h3>
        	</div>
        <div class="panel-body">
          	<table id="lista_leiloes" class="table table-striped">
				<thead>
	    			<tr>
				        <th>ID</th>
				        <th>Code</th>
    ...
    <div class="col-xs-6">
    	<div class="panel panel-primary">
        	<div class="panel-heading">
          		<h3 class="panel-title">Closed Auctions</h3>
        	</div>
        <div class="panel-body">
          	<table id="lista_leiloes" class="table table-striped">
				<thead>
				...
				<s:iterator value="myAuctionsClosed">
				<s:set var="idLeilao"> <s:property value="id"/></s:set>
